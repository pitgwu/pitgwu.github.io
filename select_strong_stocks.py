...
def generate_html_report(df, target_date):
    ...
    <head>
        ...
        <style>
            ...
            th::after {{ content: ' ⇅'; font-size: 0.8em; opacity: 0.3; }}
            ...
            function sortTable(n) {{
                ...
                while (switching) {{
                    ...
                    for (i = 1; i < (rows.length - 1); i++) {{
                        ...
                        // 清洗數據以便排序 (移除 %, , x, 🔥 等非數字字符)
                        var xVal = x.innerText.replace(/[%,,🔥x]/g, "").trim();
                        var yVal = y.innerText.replace(/[%,,🔥x]/g, "").trim();
            ...
            <div class="card">
                <div class="table-wrapper">
                    <table id="stockTable">
                        <thead>
                            <tr>
                                <th width="5%" onclick="sortTable(0)">No.</th>
                                <th width="15%" onclick="sortTable(1)">代號/名稱</th>
                                <th width="15%" onclick="sortTable(2)">產業</th>
                                <th width="15%" onclick="sortTable(3)">收盤</th>
                                <th width="15%" onclick="sortTable(4)">漲跌幅</th>
                                <th width="15%" onclick="sortTable(5)">成交量</th>
                                <th width="20%" onclick="sortTable(6)">量增比</th>
                            </tr>
                        </thead>
                        <tbody>
    """
